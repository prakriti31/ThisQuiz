...
<html>
    <head>
        <title>Add the question | ThisQuiz</title>
        <!-- add icon link -->
          ...
          <section class="error">
            ...
            <div class="error__content">
              <div class="error__message message">
                <h1 class="message__title">What's Next?</h1>
              </div>
              <div class="error__nav e-nav">
                <a href="createquiz.php" target="" class="e-nav__link"></a>
                <a href="mainquiz.php" target="" class="e-nav__link2"></a>
              </div>
            </div>
            <!-- END Content -->
