          ...
          <section class="error">
            ...
            <div class="error__content">
              <div class="error__message message">
                <h1 class="message__title">SCHOOL</h1>
              </div>
              <div class="error__nav e-nav">
                <a href="logininsideschool.php" target="" class="e-nav__link"></a>
                <a href="schoolhome.php" target="" class="e-nav__link2"></a>
              </div>
            </div>
            <!-- END Content -->
