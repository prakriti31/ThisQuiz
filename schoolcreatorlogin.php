...
if(isset($_POST['username']))
    {
        ...
        if(mysqli_connect_errno())
        {
            ...
            {
                header("Location: ./schoolcreatorlogin.html?error=passwordnotmatch");
                //exit();
            }
            else{
                session_start();
...
<h1>School Creator login</h1>
    <form id="login-form" method="post" action="schoolcreatorlogin.php" >
        <table border="0.5">
            <tr>
            ...
            <tr>
                ...
                <td><div><a href="schoolcreatorlogin.php"><input type="reset" value="Reset" class="btn"></a></div>
