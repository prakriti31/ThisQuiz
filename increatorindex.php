...
<html>
    <head>
        <title>Independent Creator | ThisQuiz</title>
        <!-- add icon link -->
          ...
          <section class="error">
            ...
            <div class="error__content">
              <div class="error__message message">
                <h1 class="message__title">INDEPENDENT CREATOR</h1>
              </div>
              <div class="error__nav e-nav">
                <a href="mainlogin.php" target="" class="e-nav__link"></a>
                <a href="individualsignup.php" target="" class="e-nav__link2"></a>
              </div>
            </div>
            <!-- END Content -->
